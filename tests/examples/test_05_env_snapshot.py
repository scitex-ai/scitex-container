#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File: /home/ywatanabe/proj/scitex-container/tests/examples/test_05_env_snapshot.py

"""Smoke test for examples/05_env_snapshot.py.
...
EXAMPLE = Path(__file__).resolve().parents[2] / "examples" / "05_env_snapshot.py"
