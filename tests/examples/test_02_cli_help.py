#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File: /home/ywatanabe/proj/scitex-container/tests/examples/test_02_cli_help.py

"""Smoke test for examples/02_cli_help.sh.
...
EXAMPLE = Path(__file__).resolve().parents[2] / "examples" / "02_cli_help.sh"
