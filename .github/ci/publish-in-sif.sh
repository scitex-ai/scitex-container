...
# (project=scitex-container, owner=ywatanabe1989, repo=scitex-container,
...
TMPDIR="/tmp/publish-scitex_container-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-container dist/* uploaded to PyPI via manual OIDC trusted publishing"
